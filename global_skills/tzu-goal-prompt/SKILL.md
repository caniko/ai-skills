...
```sh
python3 ~/canix/canix/projects/owned/ai-skills/global_skills/tzu-goal-prompt/scripts/tzu_goal_prompt.py
```
...
```sh
python3 ~/canix/canix/projects/owned/ai-skills/global_skills/tzu-goal-prompt/scripts/tzu_goal_prompt.py --self-test
```
