...
```sh
python3 /data/nvme0/can/canix/projects/repos/owned/codeberg.org/caniko/ai-skills/global_skills/tzu-goal-prompt/scripts/tzu_goal_prompt.py
```
...
```sh
python3 /data/nvme0/can/canix/projects/repos/owned/codeberg.org/caniko/ai-skills/global_skills/tzu-goal-prompt/scripts/tzu_goal_prompt.py --self-test
```
